...
PWD=$(shell pwd)
INCLUDES=-Isrc
TEST_INCLUDES=-Isrc -Iext/include -Iext/include/gtest -Iext/include/HippoMocks
APP=dist/calculo
...
$(APP_TEST): $(APP)
	...
	$(CXX) -o $(APP_TEST) output/MainTest.o output/Calculo.o output/Fibonacci.o output/Primos.o output/SalvaCalculo.o output/TestFibonacci.o output/TestPrimos.o output/TestCalculo.o output/TestSalvaCalculo.o $(LDFLAGS)
